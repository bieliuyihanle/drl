...
class cvrpAlnsEnv_LSA1(Env):
    ...
    #     nb_customers, truck_capacity, dist_matrix_data, dist_depot_data, demands_data = cvrp_helper_functions.read_input_cvrp(
    ...
    #     """
    #
    #     # 如果提供了 seed 参数，使用它来设置随机数生成器的种子
    #     if seed is not None:
    #         self.np_random, seed = seeding.np_random(seed)
    #     else:
    #         # 如果没有提供 seed，则使用随机生成的种子
    #         self.np_random, seed = seeding.np_random(random.randint(0, 10000))
    #
    #     # 随机选择问题实例
    #     self.instance = random.choice(self.instances)
    #
    ...
    #
    #     # 返回观察结果和信息字典
    #     return self.make_observation(), {"info": "reset complete"}
